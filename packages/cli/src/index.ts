...
checkCmd
	...
	.option('--patch [vendor]', 'Generate ready-to-deploy virtual patches (cloudflare, aws, modsecurity, coraza, nginx, gcp, azure, haproxy, caddy, apache, k8s, all)')
...
program
	...
	.option('-w, --waf <vendor>', 'Target WAF vendor (cloudflare, aws, modsecurity, coraza, nginx, gcp, azure, haproxy, caddy, apache, k8s, all)', 'all')
