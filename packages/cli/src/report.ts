...
import { generateSARIFReport, generateMarkdownReport } from '@waf-checker/core';
...
export function writeReport(
	...
	if (format === 'json') {
		...
		if (type === 'check') {
			outputContent = generateMarkdownReport(results, urlOrFile);
		} else {
