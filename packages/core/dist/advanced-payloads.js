 ...
 */
export function generateEncodedPayloads(originalPayloads) {
 ...
 */
export function generateWAFSpecificPayloads(wafType, basePayload) {
 ...
 */
export function generateHTTPManipulationPayloads(basePayload, technique = 'pollution') {
