...
export const WAF_SIGNATURES: WAFSignature[] = [
	...
	// NGINX App Protect / NAXSI
	{
		...
		statusCodes: [403],
		bodyPatterns: [/The request was rejected/i, /NAXSI/i, /Request Rejected/i],
	},
	...
	// HAProxy Enterprise WAF
	{
		...
		headers: {},
		statusCodes: [403],
		bodyPatterns: [/HAProxy/i, /Protected by HAProxy/i, /Request Blocked/i],
	},
	...
	// IBM DataPower
	{
		...
		statusCodes: [403],
		bodyPatterns: [/DataPower/i, /Transaction Error/i, /Access Denied/i],
	},
